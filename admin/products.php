...
<head>
    ...
    <style>
        ...
        .bg-secondary {
            background-color:  #4b053f !important;
        } */
    </style>
</head>
        ...
        <!-- <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark" style="height: 100%;">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <img src="../images/madein.png" style="border-radius: 50%;" width="100px" height="100px" alt="0">
                </a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4" style="background-color: #fff !important; ">
                            <img src="https://st2.depositphotos.com/4451541/7797/v/950/depositphotos_77979842-stock-illustration-hand-made-lettering-watercolor-vector.jpg" width="550px" height="560px">
                        </div>
                    </div>
                </div>
            </div>
