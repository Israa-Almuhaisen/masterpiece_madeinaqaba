                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span  class="footerlink"><a href="info@madeinaqaba.com" class="footerlink">info@madeinaqaba.com</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2023, All Right Reserved <a href="#">Made in Aqaba</a></p>
                        </div>
                    </div>
